...
if __name__ == "__main__":
    ...
    world_pitch_angles = np.linspace(86.025, 87.975, 40) # test/val data
    ...
    config = {
        ...
        'data_path': Path.home()/'group'/'project'/'results'/'beamforming'/\
        'time_dependent'/'beamform_signals'\
        /'220526_dl_grid_84to90deg_1to45mm_validation.h5', 

        ########### CHECKPOINT ################
        'checkpoint': Path.home()/'group'/'project'/'results'/\
        'machine_learning'/'dnn'/'triggering'/'checkpoints'/'models'
        /f'220526_{87.9}to{88.0}deg_1to3mm_model1_1vsall_ensemble.tar',

        ########## EVAL RESULT ###############
        'eval': Path.home()/'group'/'project'/'results'/\
        'machine_learning'/'dnn'/'triggering'/'eval_outputs'/'signal_grid'/\
        f'220527_{87.9}to{88.0}deg_1to3mm_model1_1vsall_ensemble_val.npz',

        'rank':0,

        #'data_energy':np.linspace(18545, 18555, 11),
        #'data_energy':np.array([18545.5, 18550.5, 18554.5]), # test data
        'data_energy':np.array([18545, 18550, 18555]), # val data
        ...
        #'target_energy': np.array([18545.5, 18550.5, 18554.5]),
        'target_energy': np.array([18545, 18550, 18555]), # val data
        'target_pitch': np.array([87.925, 87.975]),
