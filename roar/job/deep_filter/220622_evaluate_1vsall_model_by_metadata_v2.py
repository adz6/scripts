...
def LoadSignal(config, path, samples=8192):
    ...
    if path.name.endswith('.npy'):
        ...
        print(f'The number of unique training signals is {train_inds.size}')
...
if __name__ == "__main__":
    ...
    #pitch_splits = np.array_split(np.linspace(85.5, 88.0, 26), 13)
    ...
    config = {
        ...
        /f'220621_86.5to88.0deg_5mm_model1_1vsall_v5.tar',
        ########### EVAL RESULT ###############
        'eval': Path.home()/'group'/'project'/'results'/\
        'machine_learning'/'dnn'/'triggering'/'deep_filter_paper'/'eval'\
        /f'220622_86.5to88.0deg_5mm_model1_1vsall_v1_test_output.npz',
