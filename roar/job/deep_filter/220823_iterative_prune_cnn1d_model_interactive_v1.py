...
parser.add_argument('--prunes', dest='prunes', action='store', default=1, type=int)
...
checkpoint_path = str(output_repo/'220826_iter_prune_test'/f'model0_prune0.tar')

datapath = data_repo/'220609_dl_test_data_85to88deg_18575to18580ev_5mm_random.h5'

conv_dict = {
    'channels':[2,20,20,20,20],
    'kernels':[4,4,4,4],
    'strides':[4,4,4,4],
    'act': nn.LeakyReLU,
}
linear_dict = {
    'sizes': [cnn1d.output_size(conv_dict, 8192),1024,512,64,2],
    'act': nn.LeakyReLU,
}
...
train.IterativePruneModel(0, model, optimizer, loss_fcn,\
