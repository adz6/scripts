...
if __name__=='__main__':
    ...
    config = {
        'train_dir': str(output_repo/'220816_low_pitch_eval'),
        'job_name':'eval_cnn_1',
        'checkpoint': str(output_repo/'220816_low_pitch_train'/'train_cnn_1'/'train_cnn_1_checkpoint.tar'), # what model to use
        'script': str(script_repo/'machine_learning'/'220816_eval_model_v2.py'), # the evaluation script
        'time_string':'5:00:00',
        'ngpu': 1,
        'gpu_type': 'gc_v100s',
        'mem': 200,
