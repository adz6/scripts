...
if __name__=='__main__':
    ...
    config = {
        'train_dir': str(output_repo/'220816_pruning_test'),
        'job_name':'prune_cnn_0',
        'script': str(script_repo/'machine_learning'/'220816_iterative_prune_model_v1.py'), # the evaluation script
