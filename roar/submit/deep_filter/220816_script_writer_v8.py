...
def make_command(**kwargs):
    ...
    if kwargs['model'] == 'cnn':
        ...
        + f' --prunes {kwargs["prunes"]}' + f' --model {kwargs["model"]}'\
        + f' --init_linear_size {kwargs["init_lin"]}'
    
    elif kwargs['model'] == 'fc':
        pass
...
if __name__=='__main__':
    ...
    config = {
        'train_dir': str(output_repo/'220816_test_real_cnn'),
        'job_name':'real_cnn_0',
        'script': str(script_repo/'machine_learning'/'220816_iterative_prune_model_v2.py'), # the evaluation script
